...
import { LayoutDashboard, CheckSquare, FolderKanban, Calendar, FileText, Tag, BarChart3, Settings, LogOut } from 'lucide-react'
    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <aside className="w-64 bg-white border-r border-gray-200 flex flex-col shadow-sm">
        ...
        <div className="p-3 border-t border-gray-100 space-y-1">
          ...
          <button
            onClick={logout}
            className="w-full flex items-center gap-3 px-4 py-3 text-gray-700 hover:bg-red-50 hover:text-red-600 rounded-xl transition-all duration-200"
          >
